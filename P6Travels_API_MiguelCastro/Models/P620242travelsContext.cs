...
namespace P6Travels_API_MiguelCastro.Models;
...
public partial class P620242travelsContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__Country__10D160BF70B4B476");
        ...
        {
            entity.HasKey(e => e.DestionationId).HasName("PK__Destinat__12F2541F2584C6D7");
        ...
        {
            entity.HasKey(e => e.HostingId).HasName("PK__Hosting__B2C2DF847D00DD2A");
        ...
        {
            entity.HasKey(e => e.ReservationId).HasName("PK__Reservat__B7EE5F04F79DA306");
        ...
        {
            entity.HasKey(e => e.ActivityId).HasName("PK__Schedule__45F4A7F1A8E68DE8");
        ...
        {
            entity.HasKey(e => e.TourId).HasName("PK__Tour__604CEA10F872A3CA");
        ...
        {
            entity.HasKey(e => e.TransportId).HasName("PK__Transpor__19E9A17DDF892FBC");
        ...
        {
            entity.HasKey(e => e.TravelId).HasName("PK__Travel__E9315215DA2B0F13");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCACF3EBDF06");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A555038548D");
